...
<html>
	...
	<div class="toolbar">
		...
		<button class="ui blue button ajax-post" url="<?php echo U('Perappro/changeStatus',array('method'=>'resumeUser'));?>" target-form="ids">同 意</button>
		<button class="ui blue button ajax-post" url="<?php echo U('Perappro/changeStatus',array('method'=>'forbidUser'));?>" target-form="ids">拒 绝</button>-->
	</div>
	<!-- 数据列表 -->
		...
		<tbody>
			<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							...
							<?php
 echo "<a href='".U("Perappro/info?id=$vo[id]")."'>详情</a>"; ?>
						</td>
	...
	<script type="text/javascript">
		window.onload = function(){
			setInterval("location.reload()",1000*60*5);
		}
		//导航高亮
