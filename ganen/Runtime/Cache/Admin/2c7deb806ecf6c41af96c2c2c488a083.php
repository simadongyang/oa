            ...
            <div class="form-item">             
                    ...
                    <p style="margin-top:30px;">
                        <?php echo ($appro["username"]); ?>（发起）
                                <?php if(is_array($appro["info"])): $i = 0; $__LIST__ = $appro["info"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-><?php echo ($vo["username"]); ?>
								 (
									  
									<?php if(($vo['status'] == 1) ): ?>通过
										<?php elseif($vo['status'] == 0): ?>拒绝
