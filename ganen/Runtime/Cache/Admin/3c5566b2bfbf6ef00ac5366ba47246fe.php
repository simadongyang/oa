...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/Build/Admin/Style/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="/Build/Admin/Style/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
