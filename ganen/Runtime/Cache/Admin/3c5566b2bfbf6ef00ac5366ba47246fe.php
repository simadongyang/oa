...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/sima/Build/Admin/Style/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="/sima/Build/Admin/Style/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
	...
	<!--[if lt IE 9]>
    <script type="text/javascript" src="/sima/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]-->
    <!--[if gte IE 9]><!-->
