...
<html>
	...
	<div class="toolbar">
		<a id="add-group" class="ui blue button" href="<?php echo U('createGroup');?>">新 增</a>
		<a url="<?php echo U('changestatus',array('method'=>'resumeGroup'));?>" class="ui blue button ajax-post" target-form="ids">启 用</a>
		<a url="<?php echo U('changestatus',array('method'=>'forbidGroup'));?>" class="ui blue button ajax-post" target-form="ids">禁 用</a>
		<a url="<?php echo U('changestatus',array('method'=>'deleteGroup'));?>" class="ui blue button ajax-post confirm" target-form="ids">删 除</a>
	</div>
	<!-- 数据列表 -->
	<table class="ui celled table">
		...
		<tbody>
			<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<a href="<?php echo U('AuthManager/editgroup?id='.$vo['id']);?>"><?php echo ($vo["title"]); ?></a>
						</td>
